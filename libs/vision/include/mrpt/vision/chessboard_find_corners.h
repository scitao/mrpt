...
/** Look for the corners of a chessboard in the image using one of two different
  *methods.
  *
  *  The search algorithm will be OpenCV's function cvFindChessboardCorners or
  *its improved
  *   version published by M. Rufli, D. Scaramuzza, and R. Siegwart. See:
  ...
  *
  *  After detecting the corners with either method, it's called
  *"cvFindCornerSubPix" to achieve subpixel accuracy.
  *
